...
def main():
    ...
    errors = source_errors + image_errors + layout_errors
    warnings = source_warnings + image_warnings + layout_warnings
    report = {
        "config": str(cfg_path),
    ...
    if args.contact_sheet:
        make_contact_sheet(image_items, project_dir, resolve(project_dir, args.contact_sheet))
